...
function IntroductionAboutMe() {
    return (
        <Fade triggerOnce>
            ...
            <p>
                Currently, I am actively maintaining [Hydro Helper](https://github.com/langningchen/hydro-helper), an unofficial Visual Studio Code (VSCode) extension designed to streamline problem-solving for users of the [Hydro Online Judge platform](https://hydro.ac/).
